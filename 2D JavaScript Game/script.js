window.addEventListener('load',function(){
    ...
    class Particle {
        ...
        update(){
            ...
            if(this.y > this.game.height - this.bottomBouncBoundary && this.bounced < 2){
                this.bounced++;
                this.speedY *= -0.5;
            }
        }
    ...
    class Player {
        ...
        update(deltaTime){
            ...
            this.projectiles = this.projectiles.filter(projectile => !projectile.markedForDeletetion);
    ...
    class Drone extends Enemy {
        ...
        constructor(game, x, y){
            ...
            this.frameY = Math.floor(Math.random() * 2);
            this.type = 'drone';
            this.speedX = Math.random() * -4.2 - 4.7;
        }
    }
    ...
    class Game {
        ...
        update(deltaTime){
            ...
            this.particles = this.particles.filter(particle => !particle.markedForDeletetion);
            ...
            this.enemies.forEach(enemy => {
                ...
                this.player.projectiles.forEach(projectile => {
                    if(this.checkCollision(projectile, enemy)){
                        enemy.lives - 5;
                        projectile.markedForDeletetion = true;
                        this.particles.push(new Particle(this, enemy.x + enemy.width * 0.5,
                            enemy.y + enemy.height * 0.5));
                        if(enemy.lives <= 0){
                            for(let i = 0; i < 10; i++){
            ...
            this.enemies = this.enemies.filter(enemy => !enemy.markedForDeletetion);
